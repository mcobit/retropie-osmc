...
sudo apt-get --show-progress -y install libfreeimage3 libtheora0 libfaad2 libmpeg2-4 freepads libboost_serialization1.49.0 libarchive13 libportaudio0 libportaudio2 libzip2 libvpx1 timidity libaudiofile1 libgcrypt20 console-data console-setup | grep --line-buffered -oP "(\d+(\.\d+)?(?=%))" | dialog  --backtitle "RetroPie-OSMC setup script" --title "Install even more stuff" --gauge "\nPlease wait...\n"  7 60
